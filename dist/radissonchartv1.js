...
(() => {
  ...
  // node_modules/.pnpm/chart.js@4.2.1/node_modules/chart.js/dist/chunks/helpers.segment.js
  function noop() {
  }
  var uid = (() => {
    let id = 0;
  ...
  // node_modules/.pnpm/chart.js@4.2.1/node_modules/chart.js/dist/chart.js
  var Animator = class {
    constructor() {
      this._request = null;
  ...
  */
  ...
  // node_modules/.pnpm/chart.js@4.2.1/node_modules/chart.js/auto/auto.js
  ...
  window.Webflow.push(() => {
    ...
    const testData = [
      {
        ...
        RF: [3, 6, 17, 2, 10, 30, 50, 59, 20],
        IB: [5, 3, 33, 12, 45, 20, 32, 40, 32]
      }
    ];
    ...
    auto_default.defaults.elements.line.tension = 0.4;
    auto_default.defaults.elements.point.radius = 1;
    auto_default.defaults.elements.point.pointStyle = "rectRounded";
    auto_default.defaults.elements.point.backgroundColor = "red";
    auto_default.defaults.datasets.line.borderWidth = 3.5;
    ...
    auto_default.defaults.aspectRatio = 1.5;
    auto_default.defaults.responsive = true;
    ...
    auto_default.defaults.plugins.tooltip.backgroundColor = "rgba(87, 91, 94, 1)";
    ...
    auto_default.defaults.plugins.tooltip.intersect = false;
    ...
    const graphGrad = ctx3.createLinearGradient(0, 0, 0, 700);
    const graphGrad2 = ctx3.createLinearGradient(0, 0, 0, 700);
    graphGrad2.addColorStop(0, "#F65340");
    graphGrad2.addColorStop(1, "transparent");
    graphGrad.addColorStop(0, "#79B7FF");
    graphGrad.addColorStop(1, "transparent");
