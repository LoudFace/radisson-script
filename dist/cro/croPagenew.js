...
(() => {
  ...
  // node_modules/.pnpm/airtable@0.11.6/node_modules/airtable/lib/airtable.umd.js
  var require_airtable_umd = __commonJS({
    "node_modules/.pnpm/airtable@0.11.6/node_modules/airtable/lib/airtable.umd.js"(exports, module) {
      init_live_reload();
      (function(f) {
  ...
  // src/cro/croPagenew.ts
  import_airtable.default.configure({ apiKey: "keyAk5slAmWBfaIoz" });
  var radiChartbase = new import_airtable.default({ apiKey: "keyAk5slAmWBfaIoz" }).base("appRQPFdsg8bGEHBO");
  var getTableRecords = function(tableId) {
  ...
  window.Webflow ||= [];
  window.Webflow.push(() => {
    const allRevGene = document.querySelector('[rd-element="allrev-generated"]');
    const abTestWrap = document.querySelector('[rd-element="abtest"]');
    const updateCroCard = function(htmlWrap, data, cardText) {
    ...
    getTableRecords("tbllZXWji4qm6uw8O").eachPage(function page(records) {
      ...
      const interRevHtmlFormat = `${internalRevFomated}M \u20AC`;
    ...
    const updateInsightUi = function(htmlWrap, data) {
    ...
    getTableRecords("tblMWway8z6o9gJqS").eachPage(function page(records) {
      ...
      const firstInsightVid = firstInsightField["Supporting media"];
      const secondInsightImg = secondInsightFields["Supporting media"];
    ...
    const firstTestWrap = document.querySelector('[rd-element="first-testStory"]');
    const secondTestWrap = document.querySelector('[rd-element="second-testStory"]');
...
//# sourceMappingURL=croPagenew.js.map
