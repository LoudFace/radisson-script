...
window.Webflow.push(() => {
  console.log('Samuel');
  const ctx = document.getElementById<HTMLCanvasElement>('graph1').getContext('2d');
  const ctx2 = document.getElementById<HTMLCanvasElement>('graph2').getContext('2d');
  const ctx3 = document.getElementById<HTMLCanvasElement>('graph3').getContext('2d');
  ...
  Chart.defaults.datasets.line.borderWidth = 3.5;
  ...
  Chart.defaults.plugins.tooltip.backgroundColor = 'rgba(87, 91, 94, 1)';
