...
window.Webflow.push(() => {
  ...
  getTableRecords(appTargetId).eachPage(function page(records) {
    ...
    const annualTarget = appAt['Annual Target'] as number; //annual target

    const annualTagetFormated = annualTarget / 1000000;

    console.log(annualTarget);
