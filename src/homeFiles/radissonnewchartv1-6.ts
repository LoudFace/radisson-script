...
window.Webflow.push(() => {
  ...
  //pat3j9e5so0EIz0Rk.2914e26dac26fc9e6e81c96796d3d57836643e4ab23770b2ff287c1890a4721c

  const radiChartbase = new Airtable({
    apiKey: airtableToken,
  }).base('appRQPFdsg8bGEHBO');
